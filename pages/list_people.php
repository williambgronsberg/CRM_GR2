    ...
    <div style="margin: 15px;">
        <div class="table-header">
            <?php if ($customer_id && $CurrentCustomer): ?>
                <h1><?php echo htmlspecialchars($CurrentCustomer['name']); ?> - Kontaktperson</h1>
            <?php else: ?>
                <h1>Alle kontaktpersoner</h1>
            <?php endif; ?>
            <div class="table-actions">
                <?php if ($customer_id && $CurrentCustomer): ?>
                    <a href="list_customers.php" class="btn-back">&larr; Tilbake</a>
                <?php endif; ?>
                <button class="btn-add" onclick="document.getElementById('addModal').classList.add('show')">+ Ny kontaktperson</button>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <label for="first_name" class="floating">Fornavn</label>
                </div>
                <div class="form-group">
                    <input type="text" id="last_name" name="last_name" placeholder=" " required>
                    <label for="last_name" class="floating">Etternavn</label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label for="email" class="floating">E-post</label>
                </div>
                <button type="submit" class="btn-submit">Ny kontaktperson</button>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <label for="update_first_name" class="floating">Fornavn</label>
                </div>
                <div class="form-group">
                    <input type="text" id="update_last_name" name="last_name" placeholder=" " required>
                    <label for="update_last_name" class="floating">Etternavn</label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label for="update_email" class="floating">E-post</label>
                </div>
                <button type="submit" class="btn-submit">Oppdater kontaktperson</button>
                <button type="button" id="updateDeleteBtn" class="btn-delete" style="display: none;">Slett</button>
            </form>
        </div>
    </div>
